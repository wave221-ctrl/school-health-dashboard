...
const CATEGORIES = ['Roofing', 'HVAC', 'Plumbing', 'Electrical', 'Windows/Doors', 'Exterior Paint/Siding', 'Interior Finishes', 'Parking Lot', 'Playground', 'Kitchen Equipment', 'Other'];
...
export default function DeferredMaintenance() {
    ...
    // Update priority whenever relevant fields change
    useEffect(() => {
    ...
    return (
        <div className="min-h-screen bg-slate-50">
                    ...
                    <div className="flex items-center gap-8">
                        ...
                        <div className="relative group">
                            ...
                            <div className="absolute left-0 mt-2 w-72 bg-white rounded-3xl shadow-xl border border-slate-100 py-2 z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                                <Link href="/calculator" className="block px-6 py-3 hover:bg-emerald-50">School Health Calculator</Link>
                                <Link href="/staff-leadership" className="block px-6 py-3 hover:bg-emerald-50">Staff & Leadership</Link>
                                <Link href="/enrollment-projection" className="block px-6 py-3 hover:bg-emerald-50">Enrollment Projection</Link>
                                <Link href="/deferred-maintenance" className="block px-6 py-3 hover:bg-emerald-50 font-medium text-emerald-700">Deferred Maintenance</Link>
                            </div>
                        </div>
                    </div>
                    <UserButton />
            ...
            <div className="max-w-7xl mx-auto px-8 py-8">
                ...
                <p className="text-slate-600 mb-8">Track your facility backlog with automatic prioritization and multi-year planning.</p>
                ...
                <div className="grid grid-cols-12 gap-6">
                    ...
                    <div className="col-span-12 lg:col-span-4 space-y-6">
                        <div className="bg-white rounded-3xl shadow-sm border p-6">
                            ...
                            <input value={schoolName} onChange={e => setSchoolName(e.target.value)} className="w-full border rounded-2xl px-4 py-3 mb-4" />
