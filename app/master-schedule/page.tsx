...
export default function MasterScheduleBuilder() {
    ...
    const generateDraft = () => {
        ...
        showNotification('Draft schedule generated! Review conflicts if any.');
    };
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-6">
            <div className="max-w-7xl mx-auto">
                ...
                {/* Notification */}
                {notification && (
                    <div className={`mb-6 p-4 rounded-2xl text-center font-medium shadow-sm ${notification.type === 'success'
                        ...
                        {teachers.map((teacher, idx) => (
                            <div key={teacher.id} className="border border-gray-200 p-5 rounded-xl mb-5 bg-gray-50">
                                ...
                                <input
                                    ...
                                    placeholder="Notes (e.g. chapel duty)"
