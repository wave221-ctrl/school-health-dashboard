...
and supporting spiritual formation.\n\n${dataSummary}`;
        ...
        <div className="min-h-screen bg-gray-50 p-6">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
                            ...
                            <div key={teacher.id} className="border border-gray-200 p-5 rounded-xl mb-5 bg-gray-50">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="e.g. Chapel duty on Wednesday, prefers no last period"
                                        className="w-full border rounded-lg p-3"
                                    />
                                </div>
                    ...
                    {/* Rooms - unchanged for brevity but has labels too */}
                    <div className="bg-white rounded-2xl shadow p-6">
                        <div className="flex justify-between items-center mb-5">
                ...
                {/* Schedule Table, Saved Scenarios, 30/60/90 Plan, and AI Panel remain the same as previous version */}
                {/* (I kept them identical for consistency) */}
