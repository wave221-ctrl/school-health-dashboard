...
export default function MasterScheduleBuilder() {
    ...
    const generateDraft = () => {
        ...
        sortedSections.forEach(section => {
            ...
            // Stronger assignment loop
            for (let pass = 0; pass < 12 && !assigned; pass++) {
    ...
    `.trim();
        ...
        try {
            const res = await fetch('/api/master-schedule-ai', {
                ...
                body: JSON.stringify({ prompt: `You are an expert Christian school master scheduler. Analyze this schedule and give 4-6 specific suggestions to improve it:\n${dataSummary}` }),
            });
