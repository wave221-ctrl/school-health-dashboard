...
export default function EnrollmentProjection() {
    ...
    useEffect(() => {
        calculate();
    }, [grades, projectionMode, simpleGrowthRate, capacityTarget]);
                ...
                <div className="wrap">
                    ...
                    <section className="hero">
                        ...
                        <div className="controls no-print">
                            <button onClick={() => setGrades(prev => [...prev, { grade: 'New Grade', current: 0, retention: 85, newStudents: 0 }])}>Add Grade</button>
                            <button className="secondary" onClick={() => setGrades(DEFAULT_GRADES)}>Load Sample Data</button>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        {grades.map((row, index) => {
                                            const projected = getProjected(grades, index, projectionMode, simpleGrowthRate);
